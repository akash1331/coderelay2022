"""
Django settings for coderelay project.
...
SECRET_KEY = 'django-insecure-otoreji72gb8j-9t#=@7(bz^r@u1j@v&o!iarwx3bst%!e-826'
...
WSGI_APPLICATION = 'coderelay.wsgi.application'
